...
namespace Transport.WebHost.Migrations
{
    ...
    [Migration("20240115145152_UpdateRideStop")]
    partial class UpdateRideStop
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Transport.Data.Models.User", b =>
                {
                    ...
                    b.Property<double>("LastPingedLatitude")
                        .HasColumnType("float");

                    b.Property<double>("LastPingedLongitude")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Transport.Data.Models.User", null)
                        .WithMany()
